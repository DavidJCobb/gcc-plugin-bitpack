...
/*
   ...
   TESTCASE: Structs containing anonymous structs.
...
void print_data() {
   ...
   printf("      .a = %u,\n", sTestStruct.a);
   printf("      .b = %u,\n", sTestStruct.b);
   printf("      .c = %u,\n", sTestStruct.named_anon.c);
   printf("      .d = %u,\n", sTestStruct.named_anon.d);
   printf("      .e = %u,\n", sTestStruct.e);
   printf("      .f = %u,\n", sTestStruct.f);
   printf("      .g = %u,\n", sTestStruct.g);
   printf("      .h = %u,\n", sTestStruct.h);
...
int main() {
   ...
   sTestStruct.a = true;
   sTestStruct.b = false;
   sTestStruct.named_anon.c = true;
   sTestStruct.named_anon.d = false;
   sTestStruct.e = true;
